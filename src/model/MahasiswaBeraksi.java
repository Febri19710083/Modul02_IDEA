...
public class MahasiswaBeraksi {
    public static void main(String[] args) throws ParseException{
        ...
        mahasiswa.nama = "Febri Muayanah";
        mahasiswa.tanggalLahir = simpleDateFormat.parse( "08-02-2001");
        ...
        mahasiswa2.npm = "19710089";
        mahasiswa2.nama = "Riski Nurliana";
        mahasiswa2.tanggalLahir = simpleDateFormat.parse( "28-03-2001");
